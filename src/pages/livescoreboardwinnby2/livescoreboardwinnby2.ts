...
/*
  Generated class for the Livescoreboardwinnby2 page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-livescoreboardwinnby2',
  templateUrl: 'livescoreboardwinnby2.html',
  providers:[PickleBallservices]
})
export class Livescoreboardwinnby2Page {
  scoresobj:any={};
	TeamAScore:any={};
	TeamBScore:any={};
	ScoringFormatObj={};
  ...
  //socket on turnament drectore
   ...
   //function for Match start to End showing time.
	...
	backtohome(){
		if(this.navParams.data.Logout===undefined){
			this.navCtrl.push(TournamentsdirectorhomePage).then(() => {
