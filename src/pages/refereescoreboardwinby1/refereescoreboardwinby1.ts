	...
	TeamBSelectFirstServePlayerName(myvalue){
		...
		if(this.Firstserve.Team1Active===true){
  		...
  		if(this.Firstserve.Team1Active && this.navParams.data.GameStatus===1){
  			if(this.Firstserve.Team1.TeamAPoints!=0){
  				...
  				this.Firstserve.CurentScore=this.Firstserve.Team2.TeamBPoints;
  			}
  			...
  			if(this.Firstserve.Team2.TeamBPoints!=0){
  				...
  				this.Firstserve.CurentScore=this.Firstserve.Team1.TeamAPoints;
  			}
  		}
  	...
  	UpdateScore(score){
		 ...
		 if(this.scoresobj[team][this.Firstserve.SetType].length >myscore){
  		...
  		if(this.scoresobj[team][this.Firstserve.SetType].length===16 && this.Firstserve.CourtChange===false){
		...
		}else if(this.scoresobj[team][this.Firstserve.SetType].length===37 && this.Firstserve.CourtChange===false && this.scoresobj[team][this.Firstserve.SetType][myscore].set==="SetThreeScores"){
		...
		}else if(this.scoresobj[team][this.Firstserve.SetType].length===22 && this.Firstserve.CourtChange===false){
  		...
  		if(this.scoresobj[team][this.Firstserve.SetType].length >myscore){
			...
			if(this.navParams.data.GameFormat ==="2 of 3 to 11"){
				...
				if(this.Firstserve.Team1Active){
					this.scoresobj.Team1[this.Firstserve.SetType][myscore-1].Point=false;
					if(this.scoresobj[team][this.Firstserve.SetType].length===16){
					...
					}else if(this.scoresobj[team][this.Firstserve.SetType].length===22){
						this.scoresobj.Team1.SetOneTimeOuts[0].Status=false;
						this.scoresobj.Team1.SetOneTimeOuts[1].Status=false;
						...
						this.scoresobj.Team2[this.Firstserve.SetType][myscore-1].Point=false;
						if(this.scoresobj[team][this.Firstserve.SetType].length===16){
						this.scoresobj.Team1.SetOneTimeOuts[0].Status=false;
						this.scoresobj.Team1.SetOneTimeOuts[1].Status=false;
						this.scoresobj.Team2.SetOneTimeOuts[0].Status=false;
